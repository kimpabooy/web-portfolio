    ...
    >
      ...
      <form className="flex flex-col lg:space-y-12 space-y-8">
        ...
        <input
          ...
          className="md:w-[500px] w-[330px] h-13 pl-3 text-lg outline-0 bg-red-500 dark:bg-yellow-500 text-white dark:text-gray-900 font-extrabold cursur-pointer tracking-wide shadow-md shadow-gray-700/20 transition-colors duration-500"
        />
      </form>
