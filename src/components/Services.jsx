...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full xl:w-[900px] la:w-[800px] md:w-[600px] grid lg:grid-cols-3 grid-cols-1 lg:gap-12 gap-32 xl:mb-0 mb-16">
        {skillCards.map((card, index) => (
          <div
            key={index}
            className="lg:max-w-[280px] md:max-w-[400px] max-w-[320] w-full mx-auto rounded-sm ring-2 ring-gray-400/20 shadow-md shadow-gray-700/20 relative isolate"
          ...
          >
            <div className="p-3 bg-gray-200 dark:bg-gray-800 transition-colors duration-500">
              ...
              ></i>
              <h3 className="md:text-2xl text-xl font-bold my-4 text red-500 dark:text-yellow-500 transtion-colors duration-500">
                {card.title}
              </h3>
            ...
            {/* kontrollera korten/ a referenserna. deras possition stämmer ej */}
            <div
